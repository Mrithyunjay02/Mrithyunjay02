...
- Active in organizing hackathons and technical events  
- State-level powerlifter  
...
Streamlined online appointment system

**OpenPark – Smart Parking System**  
*Tech Stack:* Node.js, Express, MongoDB, React  
Real-time booking with modern UI (hackathon project)

**Blockchain-Backed SaaS Security App**  
*Tech Stack:* Python, AWS, Blockchain  
Secure file operations with tamper-proof logging (Ongoing research)

**Research Centre Management System**  
*Tech Stack:* PHP, MySQL, JavaScript  
Manages research activities, publications, and candidate supervision  
...
- **LinkedIn:** [[Your LinkedIn Profile](https://www.linkedin.com/in/d-k-mrithyunjay-6160742a2/)](#)  
